 ...
 * Special Thanks to Itay: https://github.com/TomatOrg/TomatBoot/blob/master/lib/uefi/Library/guids.c
 */
...
EFI_GUID gEfiDebugPortVariableGuid = EFI_DEBUGPORT_VARIABLE_GUID;
